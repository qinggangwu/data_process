...
if __name__ == '__main__':
    ...
    xml_path = 'D:/train_data/handwriting_rec/xml1210/'
    # img_path = 'D:/data/orgimage/Chinese_orgiamge/img/'
    img_path = 'D:/data/orgimage/Chinese_orgiamge/wclall/'
    img_out_path = 'D:/train_data/wu14CC/Chinese/Chinese_1210/'
    #
    # # n = 50000           #50000  3337
    n = 240000          #  27601  110971
    # num = 0
    qg_xml_img(xml_path, img_path,img_out_path, n)

    # print(readXML('D:/xiahang/xml/5010.xml'))


    # # xml里面有空的，返回内容。
    # file_list= os.listdir('D:/Backup/桌面/data/xml/')
    # #
    # for name in file_list:
    #     n = readXML('D:/Backup/桌面/data/xml/' + name)
    #     if n == 0:
    #         print(name)
